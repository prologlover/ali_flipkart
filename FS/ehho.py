...
def jfs(xtrain, ytrain, opts):
    ...
    e_value = np.zeros([1, max_iter], dtype='float')
    ...
    while t < max_iter:
        ...
        for i in range(N):
            ...
            # E = 2 * E0 * (1 - (t / max_iter)) + random.uniform(0.2, 0.5)
            E = 2 * E0 * (1 - (t / max_iter))

            print("ddddddddddddd", max_iter, t)
            e_value[0, t] = E
            print("Iteration:", t + 1)
    ...
    # Create dictionary
    hho_data = {'sf': sel_index, 'c': curve, 'nf': num_feat, 'e': e_value}
